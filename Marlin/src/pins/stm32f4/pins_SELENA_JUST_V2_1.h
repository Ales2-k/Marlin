...
#define BOARD_INFO_NAME "SELENA JUST 2.1"
...
// Temperature Sensors
//
#define TEMP_0_PIN         PA0   // T0 <-> E0
#define TEMP_1_PIN         PA1   // T1 <-> E1
#define TEMP_BED_PIN       PA2   // T2 <-> Bed
...
#define HEATER_BED_PIN     PE13   // Hotbed
#define FAN_PIN            PE9   // Fan1
#define FAN1_PIN           PE11   // Fan0
